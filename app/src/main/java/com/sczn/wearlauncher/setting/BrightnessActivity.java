...
public class BrightnessActivity extends AbsActivity {
    ...
    private void initData() {
        ...
        switch (curLevel) {
            case 0:
                imgThumbParam.setMargins(imgThumbParam.leftMargin + 64, 0, 0, 0);
                rvGreenSeekBar.getLayoutParams().width = rvGreenSeekBar.getLayoutParams().width + 68;
                break;
            case 1:
                imgThumbParam.setMargins(imgThumbParam.leftMargin + 64 * 2, 0, 0, 0);
                rvGreenSeekBar.getLayoutParams().width = rvGreenSeekBar.getLayoutParams().width + 68 * 2;
                break;
            case 2:
                imgThumbParam.setMargins(imgThumbParam.leftMargin + 64 * 3, 0, 0, 0);
                rvGreenSeekBar.getLayoutParams().width = rvGreenSeekBar.getLayoutParams().width + 68 * 3;
                break;
        }
    }
    ...
    private void initListener() {
        ...
        mMinusView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RelativeLayout.LayoutParams imgThumbParam = (RelativeLayout.LayoutParams) mImageThumb.getLayoutParams();
                imgThumbParam.setMargins(imgThumbParam.leftMargin - 68, 0, 0, 0);
                ...
                rvGreenParms.width = rvGreenSeekBar.getLayoutParams().width - 68;
