...
public class TimeChangeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action != null && action.equals("refresh_background_service")) {
            LogUtils.d(TAG, "refresh_background_service");
            /**
             * 自动上传位置信息
             */
            checkLocation();
             ...
             * 检测上课模式
             */
            int closeInClass = Settings.System.getInt(context.getContentResolver(),"default_close_inclass",0);
            TaskInfoParse.checkIsClassModel(closeInClass);
        }
    }
    ...
    private void checkLocation() {
        try {
            ...
            LogUtils.d(TAG, "定位上传位置:" + intervalTime);
