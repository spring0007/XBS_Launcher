...
public class MenuContainFragment extends absMenuFragment {
	...
	protected void startFreshData() {
		// TODO Auto-generated method stub
		LogUtils.d(this, "startFreshData--needFresh" + needFresh);
	...
	private void fragmentChange(int style){
		...
		if(fragment != null && (fragment instanceof absMenuFragment)){
			LogUtils.d(this, "freshData()--style=" + style + "--fragment=" + fragment.toString());
	...
	private void fragmentReplace(int style){
		...
		switch (style) {
			...
			case AppListUtil.MENU_STYLE_VERTICAL:
			default:
				LogUtils.d(TAG, "fragmentReplace--fragmentAlreadyAdd(FRAGMENT_TAG_MENU_VIRTICAL)=" + fragmentAlreadyAdd(FRAGMENT_TAG_MENU_VIRTICAL));
