...
//		mCalibrationTextView.setText(getString(R.string.compass_calibration));
        ...
        mRootView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    LogUtils.e("dmm", "apk null" + e.getMessage());
                }
            }
        });
    }
    ...
    protected void startFreshData() {
        ...
        LogUtils.d(this, "startFreshData--isTmp=" + isTmp);
        if (isTmp) {
            return;
        }
        mStopDrawing = false;
    ...
    public void onSensorChanged(SensorEvent arg0) {
        // TODO Auto-generated method stub
        LogUtils.i("Card", "onSensorChanged" + arg0.values[0]);
