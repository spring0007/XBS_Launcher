...
public class NetWorkUtil {
    ...
    private static class Connection implements Runnable {
        ...
        public void run() {
            try {
                LogUtils.d(TAG, DateFormatUtil.getCurrTimeString(DateFormatUtil.HMS));
                URL url = new URL(urlStr);
                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                conn.setRequestMethod("GET");
                conn.connect();
                LogUtils.d(TAG, DateFormatUtil.getCurrTimeString(DateFormatUtil.HMS) + "--" + conn.getResponseCode());
