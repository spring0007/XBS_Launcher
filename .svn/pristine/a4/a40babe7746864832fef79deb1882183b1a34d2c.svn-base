...
public class OkhttpClientManager {
    ...
    private OkhttpClientManager() {
        ...
        LogUtils.d("OkhttpClientManager", manager.getCookieStore().getCookies().toString());
        mGson = new Gson();
    }
    ...
    private ResultCallback<String> stringResultCallback = new MyResultCallback<String>() {
        ...
        public void onError(Request request, Exception e) {
            LogUtils.e("OkhttpClientManager", "onError , e = " + e.getMessage());
        }

        @Override
        public void onResponse(String response) {
            LogUtils.e("OkhttpClientManager", "onResponse , response = " + response);
        }
