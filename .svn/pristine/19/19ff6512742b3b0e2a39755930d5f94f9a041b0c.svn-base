...
public class WearLauncherService extends Service {
    ...
    public void onCreate() {
        LogUtils.d(TAG, "onCreate--" + Calendar.getInstance().getTime() + "--" + Calendar.getInstance().getTimeInMillis());
        super.onCreate();
        ...
        LogUtils.d(TAG, "onCreate----finish--" + Calendar.getInstance().getTime() + "--" + Calendar.getInstance().getTimeInMillis());
    }

    @Override
    public void onDestroy() {
        LogUtils.d(TAG, "onDestroy--" + Calendar.getInstance().getTime() + "--" + Calendar.getInstance().getTimeInMillis());
        ...
        LogUtils.d(TAG, "onDestroy----finish--" + Calendar.getInstance().getTime() + "--" + Calendar.getInstance().getTimeInMillis());
        super.onDestroy();
    }
