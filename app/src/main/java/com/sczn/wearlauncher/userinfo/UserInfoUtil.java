...
public class UserInfoUtil {
     ...
     * @return
     */
    public static final String getKcalByStep(Context context,int step){
        return String.valueOf(new BigDecimal(
                step * 0.7 * 0.001 * getWeightValue(context) * 1.036)
     ...
     * @return
     */
    public static final String getDisByStep(Context context,int step){
        return String.valueOf(new BigDecimal(step * 0.7 * 0.001).setScale(2, BigDecimal.ROUND_HALF_UP));
    }
	 ...
	 * @param stepNumber
	 */
	public static void setStepTarget(Context context,int stepNumber){
			Settings.System.putInt(context.getContentResolver(), USER_STEP_TARGET, stepNumber);
	}
}
