...
public class CmdCode {
    ...
    public static final int PUSH = 10;           //推送确认通知
    ...
    public static final int FENCE_INFO = 14;        //安全围栏
    public static final int DAY_REMIND = 15;        //日程提醒
    public static final int PUSH_REISSUE = 19;        //推送补发
    ...
    public static final int FENCE_ALARM = 102;  //安全围栏提醒
    public static final int LOW_POWER = 103;    //手表低电压提醒
    public static final int SIM_CHANGE = 104;   //SIM卡拔出提醒
    public static final int EMERGENCY_CALL = 105;   //紧急接听提醒
    public static final int CHAT_MSG = 108;     //聊天收到消息通知
