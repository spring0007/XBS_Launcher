        ...
        try {
            if (AppMenu.MENU_TYPE_MORE == menu.getMenuType()) {
                ...
                if (moreMenu != null) {
                    ...
                    LogUtils.e(TAG, "AppListUtil.getInctance().getMoreMenu() = null");
                }
                return;
                ...
                if (androidAssist != null) {
                    ...
                    LogUtils.e(TAG, "AppListUtil.getInctance().getAssistantMenu() = null");
                }
                return;
            ...
            LogUtils.d(TAG, "menu:" + menu.toString());
            if (menu.getAction() != null) {
                ...
                if (info != null) {
                    ...
                    Intent i = new Intent();
                    LogUtils.e(TAG, "AppListUtil.packageName="+info.activityInfo.packageName+",activityname="+info.activityInfo.name);
