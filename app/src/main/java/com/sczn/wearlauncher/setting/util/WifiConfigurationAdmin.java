...
public class WifiConfigurationAdmin {
    ...
    public static WifiConfiguration createWifiNoPassInfo(String SSID, String password) {
        ...
        LogUtils.d(TAG, "into nopass  SSID = " + SSID + "  Password = " + password + " Type = ");
        ...
        LogUtils.d(TAG, "out nopass  SSID = " + SSID + "  Password = " + password + " Type = ");
        return config;
    }
    ...
    public static WifiConfiguration createWifiWepInfo(String SSID, String password) {
        ...
        LogUtils.d(TAG, "into WIFICIPHER_WEP   SSID = " + SSID + "  Password = " + password);
        WifiConfiguration config = new WifiConfiguration();
        config = createWifiInfo(config, SSID, password);
        ...
        config.allowedKeyManagement.set(WifiConfiguration.KeyMgmt.NONE);
        config.wepTxKeyIndex = 0;
        LogUtils.d(TAG, "out WIFICIPHER_WEP   SSID = " + SSID + "  Password = " + password);
        return config;
    ...
    public static WifiConfiguration createWifiWpaInfo(String SSID, String password) {
        if (TextUtils.isEmpty(password)) {
            ...
            LogUtils.d(TAG, "密码为空");
            LogUtils.d(TAG, "createWifiWpaInfo SSID = " + SSID + " | Password = " + password);
            ...
            LogUtils.d(TAG, "out WIFICIPHER_WPA SSID = " + SSID + " | Password = " + password);
    ...
    private static WifiConfiguration createWifiInfo(WifiConfiguration config, String SSID, String password) {
        LogUtils.d(TAG, "into wifi热点连接配置   SSID = " + SSID + "  Password = " + password);
        ...
        LogUtils.d(TAG, "into wifi热点连接配置   config.SSID = " + config.SSID + "  Password = " + password);
