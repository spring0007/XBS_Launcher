...
public class HttpUtil {
    ...
    public void httpGet(String urlString, String dirString) {
        ...
        try {
            ...
            try {
                ...
                LogUtils.d("httpGet", "success");
            } catch (IOException e) {
                LogUtils.d("httpGet", "fail");
                e.printStackTrace();
            }
        }
    }
    ...
    public void httpGetContactAvatar(String urlString, String phoneNum) {
        ...
        try {
            ...
            try {
                ...
                LogUtils.d("httpGetContactAvatar", "fail");
            } catch (IOException e) {
                LogUtils.d("httpGetContactAvatar", "fail");
                e.printStackTrace();
            }
    ...
    public static void httpPost(String urlstr, String uploadFile, String newName) {
        LogUtils.d("httpPost", "urlstr=" + urlstr + ";uploadFile=" + uploadFile + ";newName=" + newName);
        String end = "\r\n";
        String twoHyphens = "--";
    ...
    public static Boolean uploadFile(String[] picPaths, String requestURL) {
        ...
        try {
            ...
            LogUtils.e("uploadFile", "response code:" + res);
            if (res == 200) {
                return true;
            }
        } catch (IOException e) {
