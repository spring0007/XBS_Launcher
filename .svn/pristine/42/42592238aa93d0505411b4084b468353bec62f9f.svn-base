    ...
    private void initData(int volume) {
        ...
        switch (curLevel) {
            case 0:
                ...
                break;
            case 1:
                imgThumbParam.setMargins(initialThumbMargin + 68, 0, 0, 0);
                rvGreenParams.width = initialGreenWidth + 68;
                mImageThumb.setImageResource(R.drawable.icon_normal_volume);
                rvGreenSeekBar.setVisibility(View.VISIBLE);
                break;
            case 2:
                imgThumbParam.setMargins(initialThumbMargin + 68 * 2, 0, 0, 0);
                rvGreenParams.width = initialGreenWidth + 68 * 2;
                mImageThumb.setImageResource(R.drawable.icon_normal_volume);
                rvGreenSeekBar.setVisibility(View.VISIBLE);
                break;
            case 3:
                imgThumbParam.setMargins(initialThumbMargin + 68 * 3, 0, 0, 0);
                rvGreenParams.width = initialGreenWidth + 68 * 3;
                mImageThumb.setImageResource(R.drawable.icon_normal_volume);
                rvGreenSeekBar.setVisibility(View.VISIBLE);
                break;
        }
