...
public class CardFragmentSleep extends absDialogFragment {
		...
		mRootView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					LogUtils.e(this, "gotoSleepActivity--" + e.toString());
				}
			}
		});
	}
	...
	private void setData(ArrayList<ModelSleepState> values){
		...
		if(mValues != null){
			...
			LogUtils.d(this,"SleepState.lightSleepTime=" + ModelSleepState.lightSleepTime + "--PER_HOUR=" + PER_HOUR + "--lightHour=" + lightHour);
	...
	private class QueryDbTask extends AsyncTask<Void, Void, ArrayList<ModelSleepState>>{
		...
		protected ArrayList<ModelSleepState> doInBackground(Void... params) {
            ...
            LogUtils.d(this, "cursor.getColumnCount=" + cursor.getColumnCount() + "--cursor.getCount=" + cursor.getCount());
            ...
            do{
            	...
            	LogUtils.d(this, DateFormatUtil.getTimeString(DateFormatUtil.HMS, cursor.getLong(cursor.getColumnIndex(
